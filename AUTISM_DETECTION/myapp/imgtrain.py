...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default='C:\\Users\\USER\\Music\\dataset\\dataset\\',
        help='Path to folders of labeled images.'
        )
    parser.add_argument(
        '--output_graph',
        type=str,
        default='C:\\Users\\USER\\Desktop\\project\\AUTISM_DETECTION\\AUTISM_DETECTION\\image\\output_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--output_labels',
        type=str,
        default='C:\\Users\\USER\\Desktop\\project\\AUTISM_DETECTION\\AUTISM_DETECTION\\image\\output_labels.txt',
        help='Where to save the trained graph\'s labels.'
        )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='C:\\Users\\USER\\Desktop\\project\\AUTISM_DETECTION\\AUTISM_DETECTION\\image\\retrain_new_logs',
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='C:\\Users\\91815\\PycharmProjects\\Arplantdisease\\static'
