...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default=r'C:\Users\USER\Desktop\softwaresss\dataset\dataset1/',
        help='Path to folders of labeled images.'
        )
    parser.add_argument(
        '--output_graph',
        type=str,
        default=r'C:\Users\USER\Desktop\project\AUTISM_DETECTION\AUTISM_DETECTION\myapp\type\output_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--output_labels',
        type=str,
        default=r'C:\Users\USER\Desktop\project\AUTISM_DETECTION\AUTISM_DETECTION\myapp\type\output_labels.txt',
        help='Where to save the trained graph\'s labels.'
        )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default=r'C:\Users\USER\Desktop\project\AUTISM_DETECTION\AUTISM_DETECTION\myapp\type\retrain_new_logs',
